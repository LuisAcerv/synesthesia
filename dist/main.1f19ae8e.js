...
_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  "use strict"; //set up canvas

  var canvas, ctx, cw, ch, waveForm, ctxw, URL, context, playButton, audioE, analyser, audio, duration, play, getDataFromAudio, currentTime, draw, convert;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          convert = function _convert(Uint8Arr) {
            return String.fromCharCode.apply(null, Uint8Arr);
          };

          draw = function _draw(t) {
            ...
            console.log(convert(data.f), convert(data.t));
            var waveSum = 0; //draw live waveform and oscilloscope
            ...
            for (var _i = 0; _i < data.t.length; _i++) {
              ctx.fillStyle = "red";
              ctx.fillRect(_i * 2, data.t[_i], 1, 1);
            }
          ...
          getDataFromAudio = function _getDataFromAudio() {
            ...
            return {
              f: freqByteData,
              t: timeByteData
            }; // array of all 1024 levels
          };

          play = function _play(audioBuffer) {
          ...
          ch = canvas.height = 255;
          waveForm = document.createElement("canvas");
          waveForm.width = 1024;
          waveForm.height = 255;
          ctxw = waveForm.getContext("2d");
